...
Elm.Foundation = Elm.Foundation || {};
Elm.Foundation.make = function (_elm) {
   "use strict";
   _elm.Foundation = _elm.Foundation || {};
   if (_elm.Foundation.values)
   return _elm.Foundation.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   _elm.Foundation.values = {_op: _op
                            ,tooltip: tooltip};
   return _elm.Foundation.values;
};
...
Elm.InputFields = Elm.InputFields || {};
Elm.InputFields.make = function (_elm) {
   "use strict";
   _elm.InputFields = _elm.InputFields || {};
   if (_elm.InputFields.values)
   return _elm.InputFields.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $OutputFields = Elm.OutputFields.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $Task = Elm.Task.make(_elm),
   ...
   var dummyTask = $Task.succeed(_L.fromArray([{_: {}
                                              ...
                                              ,{_: {}
                                               ...
                                               ,subject: {_: {}
                                                         ,name: "wirjvn"
                                                         ,sid: 0}}]));
   var targetToString = function (_v0) {
      return function () {
         return function () {
            var _v2 = _v0.scope;
            switch (_v2)
            {case "cell":
               return A2($Basics._op["++"],
                 "Cell on ",
                 A2($Basics._op["++"],
                 $Maybe.withDefault("invalid")(A2($Util._op["!!"],
                 $Util.days,
                 _v0.day)),
                 A2($Basics._op["++"],
                 " in slot ",
                 $Basics.toString(_v0.slot))));
               case "day":
               return A2($Basics._op["++"],
                 "Day ",
                 $Maybe.withDefault("invalid")(A2($Util._op["!!"],
   ...
   var subToOption = function (s) {
      return A2($Html.option,
      _L.fromArray([$Html$Attributes.value($Basics.toString(s.sid))]),
      _L.fromArray([$Html.text(s.name)]));
   };
   var validTargetValues = _L.fromArray(["cell"
                                        ,"day"
                                        ,"slot"]);
   var targetIsValid = function ($) {
      return A2($Basics.flip,
      $List.member,
      validTargetValues)(function (_) {
         return _.scope;
      }($));
   };
   var formReady = function (m) {
      return $Basics.not($List.isEmpty(m.subjects) || $List.isEmpty(m.lessons));
   };
   var subjectIsValid = function (s) {
      return _U.cmp(s.sid,
      0) > -1 && !_U.eq(s.name,"");
   };
   var lessonIsValid = function (l) {
      return _U.cmp(l.lid,
      0) > -1 && _U.cmp(l.subject.sid,
      0) > -1;
   };
   var update = F2(function (action,
   model) {
      return function () {
         var updateRuleDay = F2(function (value,
         target) {
            return _U.replace([["day"
                               ,value]],
            target);
         });
         var updateRuleSlot = F2(function (value,
         target) {
            return _U.replace([["slot"
                               ,value]],
            target);
         });
         var lf = model.lessonField;
         var sf = model.subjectField;
         return function () {
            switch (action.ctor)
            {case "AddLesson":
               return _U.replace([["lessons"
                 ...
                 model);
               case "AddRule":
               return targetIsValid(model.target) ? function () {
                    var newRule = {_: {}
                                  ,rid: model.nrid
               ...
               case "UpdateDay":
               return _U.replace([["lessonField"
                                  ,_U.replace([["day",action._0]],
                                  lf)]],
                 model);
               case "UpdateRuleDay":
               ...
               return _U.replace([["target"
                                  ...
                                  model.target)]],
                 model);
               case "UpdateRuleTarget":
               return function () {
                    var oldTarget = model.target;
                    return _U.replace([["target"
                                       ,_U.replace([["scope"
                                                    ,action._0]],
                                       oldTarget)]],
               ...
               case "UpdateSeverity":
               return _U.replace([["currentSeverity"
                                  ,action._0]],
                 model);
               case "UpdateSlot":
               return _U.replace([["lessonField"
               ...
               return _U.replace([["subjectField"
                                  ,_U.replace([["name"
                                               ,action._0]],
                                  sf)]],
                 model);}
   ...
   var UpdateRuleTarget = function (a) {
      return {ctor: "UpdateRuleTarget"
             ,_0: a};
   };
   var UpdateRuleDay = function (a) {
      return {ctor: "UpdateRuleDay"
             ,_0: a};
   };
   var UpdateRuleSlot = function (a) {
      return {ctor: "UpdateRuleSlot"
             ,_0: a};
   };
   var AddRule = {ctor: "AddRule"};
   var UpdateDay = function (a) {
      return {ctor: "UpdateDay"
             ,_0: a};
   };
   var UpdateSlot = function (a) {
      return {ctor: "UpdateSlot"
             ,_0: a};
   };
   var UpdateSubject = function (a) {
      return {ctor: "UpdateSubject"
             ,_0: a};
   };
   var UpdateSubjectName = function (a) {
      return {ctor: "UpdateSubjectName"
             ,_0: a};
   };
   var DeleteSubject = function (a) {
      return {ctor: "DeleteSubject"
             ,_0: a};
   };
   var singleSubjectDisplay = F3(function (address,
   s,
   active) {
      return A2($Html.li,
      _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                             ...
                                                             ,_1: active}]))]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row collapse")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("subject column small-10")]),
                   _L.fromArray([A2($Html.a,
   ...
   var DeleteLesson = function (a) {
      return {ctor: "DeleteLesson"
             ,_0: a};
   };
   var singleLessonDisplay = F2(function (address,
   l) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("lesson row")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("lesson-day small-3 columns")]),
                   ...
                   _L.fromArray([$Html$Attributes.$class("has-tip button alert postfix")
                                ...
                                address,
                                DeleteLesson(l.lid))]),
                   $Foundation.tooltip("Do you want to delete me?")),
                   _L.fromArray([$Html.text("x")]))]))]));
   });
   var AddSubject = {ctor: "AddSubject"};
   var subjectFields = F2(function (address,
   model) {
      return function () {
         var enabled = subjectIsValid(model.subjectField);
         var buttonAction = enabled ? F2(function (x,
         y) {
            return A2($List._op["::"],
            x,
            y);
         ...
         address,
         AddSubject)) : F2(function (x,
         y) {
            return A2($Basics._op["++"],
            x,
            y);
         })($Foundation.tooltip("You have to enter a name for the subject, before you can add it."));
         return A2($Html.div,
         _L.fromArray([]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("row")]),
                      _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("columns asmall-12")]),
                      _L.fromArray([A2($Html.label,
                      _L.fromArray([$Html$Attributes.$for("subject-name")]),
                      _L.fromArray([$Html.text("Add subjects")]))]))]))
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.id("subject-inputs")
                                   ,$Html$Attributes.$class("row collapse")]),
                      _L.fromArray([A2($Html.div,
                                   _L.fromArray([$Html$Attributes.$class("small-10 column")]),
                                   _L.fromArray([A2($Html.input,
                                   _L.fromArray([$Html$Attributes.id("subject-name")
                                                ,$Html$Attributes.placeholder("Enter a Subject")
                                                ,$Html$Attributes.type$("text")
                                                ,$Html$Attributes.name("subject-name")
                                                ,A3($Html$Events.on,
                                                "input",
                                                $Html$Events.targetValue,
                                                function ($) {
                                                   return $Signal.message(address)(UpdateSubjectName($));
                                                })
                                                ,A2($Util.onEnter,
                                                address,
                                                AddSubject)]),
                                   _L.fromArray([$Html.text(model.subjectField.name)]))]))
                                   ,A2($Html.div,
                                   _L.fromArray([$Html$Attributes.$class("small-2 columns")]),
                                   _L.fromArray([A2($Html.a,
                                   buttonAction(_L.fromArray([$Html$Attributes.id("new-subject")
   ...
   var NoOp = {ctor: "NoOp"};
   var lessonFields = F2(function (address,
   model) {
      return function () {
         var dayToOption = function (n) {
            return A2($Html.option,
            _L.fromArray([$Html$Attributes.value($Basics.toString(n))]),
            _L.fromArray([$Html.text(A2($Maybe.withDefault,
            "invalid",
            A2($Util._op["!!"],
            $Util.days,
         ...
         var slotToOption = function (n) {
            return function () {
               var v = $Basics.toString(n);
               return A2($Html.option,
               _L.fromArray([$Html$Attributes.value(v)]),
               _L.fromArray([$Html.text(v)]));
            }();
         };
         var updateDay = function ($) {
            return $Signal.message(address)(A2($Util.withDefault,
            NoOp,
            UpdateDay)($String.toInt($)));
         };
         var updateSlot = function ($) {
            return $Signal.message(address)(A2($Util.withDefault,
            NoOp,
            UpdateSlot)($String.toInt($)));
         };
         var enabled = lessonIsValid(model.lessonField);
         var buttonAction = enabled ? F2(function (x,
         y) {
            return A2($List._op["::"],
            x,
   ...
   model) {
      return function () {
         ...
         address,
         AddRule)) : F2(function (x,y) {
            return A2($Basics._op["++"],
            x,
            y);
         })($Foundation.tooltip("You have to specify a valid target before you can press me."));
         var updateSeverity = function ($) {
            return $Signal.message(address)(A2($Util.withDefault,
            NoOp,
            UpdateSeverity)($String.toInt($)));
         };
         var updateSlot = function ($) {
            return $Signal.message(address)(A2($Util.withDefault,
            NoOp,
         ...
         _L.fromArray([A2($Html.label,
                      ...
                      ,A2($Html.select,
                      _L.fromArray([$Html$Attributes.id("update-rule-slot")
                                   ,A3($Html$Events.on,
                                   "input",
                                   $Html$Events.targetValue,
                                   updateSlot)]),
                      ...
                      function (a) {
                         return A2($Html.option,
                         _L.fromArray([]),
                         _L.fromArray([$Html.text($Basics.toString(a))]));
                      },
                      _L.range(0,10)))]));
         var updateDay = function ($) {
            return $Signal.message(address)(A2($Util.withDefault,
            NoOp,
            UpdateRuleDay)($String.toInt($)));
         };
         var updateTarget = function ($) {
            return $Signal.message(address)(UpdateRuleTarget($));
         };
         var toOption = function (i) {
            return A2($Html.option,
            _L.fromArray([$Html$Attributes.value($Basics.toString(i))]),
            _L.fromArray([$Html.text(A2($Maybe.withDefault,
            "invalid",
            A2($Util._op["!!"],
            $Util.days,
         ...
         _L.fromArray([A2($Html.label,
                      ...
                      ,A2($Html.select,
                      _L.fromArray([$Html$Attributes.id("update-rule-day")
                                   ,A3($Html$Events.on,
                                   "input",
                                   $Html$Events.targetValue,
                                   updateDay)]),
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([A2($Html.label,
                                   ...
                                   ,A2($Html.select,
                                   _L.fromArray([$Html$Attributes.id("update-severity")
                                                ,A3($Html$Events.on,
                                                "input",
                                                $Html$Events.targetValue,
                                                updateSeverity)]),
                                   ...
                                   function ($) {
                                      return function (a) {
                                         return A2($Html.option,
                                         _L.fromArray([$Html$Attributes.value(a)]),
                                         _L.fromArray([$Html.text(a)]));
                                      }($Basics.toString($));
                                   },
                                   _L.range(0,10)))]))]))))
   ...
   model) {
      return function () {
         var box = updateMailbox;
         var enabled = formReady(model);
         var buttonAction = enabled ? F2(function (x,
         y) {
            return A2($List._op["::"],
            x,
...
Elm.Main.make = function (_elm) {
   ...
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Http = Elm.Http.make(_elm),
   $InputFields = Elm.InputFields.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $OutputFields = Elm.OutputFields.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm),
   ...
   "Maybe.Maybe Types.Model",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "lessons" in v && "subjects" in v && "lessonField" in v && "subjectField" in v && "nsid" in v && "nlid" in v && "nrid" in v && "rules" in v && "target" in v && "currentSeverity" in v ? {_: {}
                                                                                                                                                                                                                                                                                                     ,lessons: typeof v.lessons === "object" && v.lessons instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.lessons.map(function (v) {
                                                                                                                                                                                                                                                                                                        return typeof v === "object" && "lid" in v && "subject" in v && "day" in v && "slot" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                    ,lid: typeof v.lid === "number" ? v.lid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                    v.lid)
                                                                                                                                                                                                                                                                                                                                                                                                    ,subject: typeof v.subject === "object" && "sid" in v.subject && "name" in v.subject ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,sid: typeof v.subject.sid === "number" ? v.subject.sid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.subject.sid)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ,name: typeof v.subject.name === "string" || typeof v.subject.name === "object" && v.subject.name instanceof String ? v.subject.name : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           v.subject.name)} : _U.badPort("an object with fields \'sid\', \'name\'",
                                                                                                                                                                                                                                                                                                                                                                                                    v.subject)
                                                                                                                                                                                                                                                                                                                                                                                                    ,day: typeof v.day === "number" ? v.day : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                    v.day)
                                                                                                                                                                                                                                                                                                                                                                                                    ,slot: typeof v.slot === "number" ? v.slot : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                    v.slot)} : _U.badPort("an object with fields \'lid\', \'subject\', \'day\', \'slot\'",
                                                                                                                                                                                                                                                                                                        v);
                                                                                                                                                                                                                                                                                                     })) : _U.badPort("an array",
                                                                                                                                                                                                                                                                                                     v.lessons)
                                                                                                                                                                                                                                                                                                     ,subjects: typeof v.subjects === "object" && v.subjects instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.subjects.map(function (v) {
                                                                                                                                                                                                                                                                                                        return typeof v === "object" && "sid" in v && "name" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                    ,sid: typeof v.sid === "number" ? v.sid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                    v.sid)
                                                                                                                                                                                                                                                                                                                                                                    ,name: typeof v.name === "string" || typeof v.name === "object" && v.name instanceof String ? v.name : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                    v.name)} : _U.badPort("an object with fields \'sid\', \'name\'",
                                                                                                                                                                                                                                                                                                        v);
                                                                                                                                                                                                                                                                                                     })) : _U.badPort("an array",
                                                                                                                                                                                                                                                                                                     v.subjects)
                                                                                                                                                                                                                                                                                                     ,lessonField: typeof v.lessonField === "object" && "lid" in v.lessonField && "subject" in v.lessonField && "day" in v.lessonField && "slot" in v.lessonField ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ,lid: typeof v.lessonField.lid === "number" ? v.lessonField.lid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    v.lessonField.lid)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ,subject: typeof v.lessonField.subject === "object" && "sid" in v.lessonField.subject && "name" in v.lessonField.subject ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ,sid: typeof v.lessonField.subject.sid === "number" ? v.lessonField.subject.sid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               v.lessonField.subject.sid)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ,name: typeof v.lessonField.subject.name === "string" || typeof v.lessonField.subject.name === "object" && v.lessonField.subject.name instanceof String ? v.lessonField.subject.name : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               v.lessonField.subject.name)} : _U.badPort("an object with fields \'sid\', \'name\'",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    v.lessonField.subject)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ,day: typeof v.lessonField.day === "number" ? v.lessonField.day : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    v.lessonField.day)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ,slot: typeof v.lessonField.slot === "number" ? v.lessonField.slot : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    v.lessonField.slot)} : _U.badPort("an object with fields \'lid\', \'subject\', \'day\', \'slot\'",
                                                                                                                                                                                                                                                                                                     v.lessonField)
                                                                                                                                                                                                                                                                                                     ,subjectField: typeof v.subjectField === "object" && "sid" in v.subjectField && "name" in v.subjectField ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                ,sid: typeof v.subjectField.sid === "number" ? v.subjectField.sid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                v.subjectField.sid)
                                                                                                                                                                                                                                                                                                                                                                                                                ,name: typeof v.subjectField.name === "string" || typeof v.subjectField.name === "object" && v.subjectField.name instanceof String ? v.subjectField.name : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                v.subjectField.name)} : _U.badPort("an object with fields \'sid\', \'name\'",
                                                                                                                                                                                                                                                                                                     v.subjectField)
                                                                                                                                                                                                                                                                                                     ,nsid: typeof v.nsid === "number" ? v.nsid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                     v.nsid)
                                                                                                                                                                                                                                                                                                     ,nlid: typeof v.nlid === "number" ? v.nlid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                     v.nlid)
                                                                                                                                                                                                                                                                                                     ,nrid: typeof v.nrid === "number" ? v.nrid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                     v.nrid)
                                                                                                                                                                                                                                                                                                     ,rules: typeof v.rules === "object" && v.rules instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.rules.map(function (v) {
                                                                                                                                                                                                                                                                                                        return typeof v === "object" && "target" in v && "severity" in v && "rid" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                         ,target: typeof v.target === "object" && "scope" in v.target && "day" in v.target && "slot" in v.target ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,scope: typeof v.target.scope === "string" || typeof v.target.scope === "object" && v.target.scope instanceof String ? v.target.scope : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.target.scope)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,day: typeof v.target.day === "number" ? v.target.day : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.target.day)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ,slot: typeof v.target.slot === "number" ? v.target.slot : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   v.target.slot)} : _U.badPort("an object with fields \'scope\', \'day\', \'slot\'",
                                                                                                                                                                                                                                                                                                                                                                                         v.target)
                                                                                                                                                                                                                                                                                                                                                                                         ,severity: typeof v.severity === "number" ? v.severity : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                         v.severity)
                                                                                                                                                                                                                                                                                                                                                                                         ,rid: typeof v.rid === "number" ? v.rid : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                         v.rid)} : _U.badPort("an object with fields \'target\', \'severity\', \'rid\'",
                                                                                                                                                                                                                                                                                                        v);
                                                                                                                                                                                                                                                                                                     })) : _U.badPort("an array",
                                                                                                                                                                                                                                                                                                     v.rules)
                                                                                                                                                                                                                                                                                                     ,target: typeof v.target === "object" && "scope" in v.target && "day" in v.target && "slot" in v.target ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                               v.target.slot)} : _U.badPort("an object with fields \'scope\', \'day\', \'slot\'",
                                                                                                                                                                                                                                                                                                     v.target)
                                                                                                                                                                                                                                                                                                     ,currentSeverity: typeof v.currentSeverity === "number" ? v.currentSeverity : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                     v.currentSeverity)} : _U.badPort("an object with fields \'lessons\', \'subjects\', \'lessonField\', \'subjectField\', \'nsid\', \'nlid\', \'nrid\', \'rules\', \'target\', \'currentSeverity\'",
      v));
   });
   ...
   $InputFields.update,
   initialModel,
   $InputFields.actions.signal);
   var dataTask = A3($Signal.map2,
   $InputFields.doUpdate,
   $InputFields.updateMailbox.signal,
   model);
   var updatePort = Elm.Native.Task.make(_elm).performSignal("updatePort",
   dataTask);
   ...
   function (v) {
      return {lessons: Elm.Native.List.make(_elm).toArray(v.lessons).map(function (v) {
                return {lid: v.lid
                       ,subject: {sid: v.subject.sid
                                 ,name: v.subject.name}
                       ,day: v.day
                       ,slot: v.slot};
             })
             ,subjects: Elm.Native.List.make(_elm).toArray(v.subjects).map(function (v) {
                return {sid: v.sid
                       ,name: v.name};
             })
             ,lessonField: {lid: v.lessonField.lid
                           ,subject: {sid: v.lessonField.subject.sid
                                     ,name: v.lessonField.subject.name}
                           ,day: v.lessonField.day
                           ,slot: v.lessonField.slot}
             ,subjectField: {sid: v.subjectField.sid
                            ,name: v.subjectField.name}
             ,nsid: v.nsid
             ,nlid: v.nlid
             ,nrid: v.nrid
             ,rules: Elm.Native.List.make(_elm).toArray(v.rules).map(function (v) {
                return {target: {scope: v.target.scope
                                ,day: v.target.day
                                ,slot: v.target.slot}
                       ,severity: v.severity
                       ,rid: v.rid};
             })
             ,target: {scope: v.target.scope
                      ,day: v.target.day
                      ,slot: v.target.slot}
             ,currentSeverity: v.currentSeverity};
   },
   model);
...
Elm.OutputFields = Elm.OutputFields || {};
Elm.OutputFields.make = function (_elm) {
   "use strict";
   _elm.OutputFields = _elm.OutputFields || {};
   if (_elm.OutputFields.values)
   return _elm.OutputFields.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Types = Elm.Types.make(_elm),
   $Util = Elm.Util.make(_elm);
   var scheduleView = function (lessons) {
      return function () {
         var row = function (l) {
   ...
   var view = function (model) {
      ...
      A2($List.map,
      function ($) {
         return scheduleView($Basics.snd($));
      },
      model.lessons));
   };
   var update = F2(function (action,
   ...
   emptyModel,
   actions.signal);
   var htmlSignal = A2($Signal.map,
   view,
   model);
   var Model = function (a) {
      return {_: {},lessons: a};
   };
   _elm.OutputFields.values = {_op: _op
                              ,htmlSignal: htmlSignal
                              ,actions: actions
                              ,NoOp: NoOp
                              ,Update: Update};
...
Elm.Types.make = function (_elm) {
   ...
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm);
   var encode_target = function (_v0) {
      return function () {
         return _L.fromArray([{ctor: "_Tuple2"
                              ,_0: "scope"
                              ,_1: $Json$Encode.string(_v0.scope)}
                             ,{ctor: "_Tuple2"
                              ,_0: "day"
                              ,_1: $Json$Encode.$int(_v0.day)}
                             ,{ctor: "_Tuple2"
                              ,_0: "slot"
                              ,_1: $Json$Encode.$int(_v0.slot)}]);
      }();
   };
   var encode_rule = function (_v2) {
      return function () {
         return $Json$Encode.object(A2($List._op["::"],
         {ctor: "_Tuple2"
         ,_0: "severity"
         ,_1: $Json$Encode.$int(_v2.severity)},
         encode_target(_v2.target)));
      }();
   };
   var encode_lesson = function (l) {
      return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                               ,_0: "subject"
                                               ,_1: $Json$Encode.string(l.subject.name)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "day"
                                               ,_1: $Json$Encode.$int(l.day)}
                                              ,{ctor: "_Tuple2"
                                               ,_0: "slot"
                                               ,_1: $Json$Encode.$int(l.slot)}]));
   };
   var encode_datafile = function (m) {
      return $Json$Encode.object(_L.fromArray([{ctor: "_Tuple2"
                                               ,_0: "lessons"
   ...
   var decode_lesson = A4($Json$Decode.object3,
   F3(function (sub,day$,slot$) {
      return {_: {}
             ,day: day$
             ,lid: 0
             ,slot: slot$
   ...
   "slot",
   $Json$Decode.$int));
   var decode_schedule = $Json$Decode.list(A3($Json$Decode.object2,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
             ,_1: v1};
   ...
   A2($Json$Decode._op[":="],
   "lessons",
   $Json$Decode.list(decode_lesson))));
   var emptyLesson = {_: {}
                     ,day: 0
                     ,lid: 0
                     ,slot: 0
   ...
   var emptyModel = {_: {}
                    ...
                    ,subjects: _L.fromArray([])
                    ,target: {_: {}
                             ,day: 0
                             ,scope: ""
                             ,slot: 0}};
   var Target = F3(function (a,
   b,
   c) {
      return {_: {}
             ,day: b
   ...
   var Rule = F3(function (a,b,c) {
      return {_: {}
             ,rid: c
             ,severity: b
             ,target: a};
   });
   var Subject = F2(function (a,
   b) {
      return {_: {}
             ,name: b
             ,sid: a};
   });
   var Lesson = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   _elm.Types.values = {_op: _op
                       ...
                       ,encode_lesson: encode_lesson
                       ,encode_datafile: encode_datafile
                       ,decode_lesson: decode_lesson
...
Elm.Util.make = function (_elm) {
   ...
   var withDefault = F3(function (v,
   f,
   res) {
      return function () {
         switch (res.ctor)
         {case "Err": return v;
            case "Ok": return f(res._0);}
         _U.badCase($moduleName,
